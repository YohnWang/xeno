...
typedef struct pthread_mutex_t      /* identify a mutex */
{
    int type; // normal or recursive
    SemaphoreHandle_t handle;
    TaskHandle_t owner;
}pthread_mutex_t;

#define _PTHREAD_MUTEX_INITIALIZER {PTHREAD_MUTEX_NORMAL, NULL}
#define PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP {PTHREAD_MUTEX_RECURSIVE, NULL}

/* Condition Variables */

typedef int pthread_cond_t;       /* identify a condition variable */
